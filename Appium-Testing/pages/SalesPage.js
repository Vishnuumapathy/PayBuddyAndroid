...
class SalesPage extends BasePage {
    ...
    get itemNameInput() { return $('//android.widget.EditText[.//android.widget.TextView[@text="Item Name"]] | //android.widget.EditText[contains(@text, "Item Name")]'); }
    get qtyInput() { return $('//android.widget.EditText[.//android.widget.TextView[@text="Qty"]] | //android.widget.EditText[contains(@text, "Qty")]'); }
    get priceInput() { return $('//android.widget.EditText[.//android.widget.TextView[@text="Unit Price"]] | //android.widget.EditText[contains(@text, "Unit Price")]'); }
    get amountInput() { return $('//android.widget.EditText[contains(@text, "Total Amount")] | //*[@resource-id="com.paybuddy:id/et_sale_amount"]'); }
    get submitSaleBtn() { return $('//android.widget.Button[contains(@text, "Create Sale")] | //*[contains(@text, "Create Sale")] | //*[@resource-id="com.paybuddy:id/btn_submit_sale"]'); }
    ...
    async createSale(customerName, itemName, qty, price) {
        if (await this.isDisplayed(await this.customerSpinner)) {
            ...
            const customerOption = $(`//android.widget.TextView[@text="${customerName}"]`);

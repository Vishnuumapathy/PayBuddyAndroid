...
import com.paybuddy.ui.screens.CustomerProfileScreen
            ...
            setContent {
                PayBuddyTheme {
                    ...
                    CustomerProfileScreen(
                        ...
                        onOtherSalesClick = { id ->
                            val bundle = Bundle().apply { putString("customerId", id) }
                            findNavController().navigate(
                                R.id.action_customerProfileFragment_to_customerSalesListFragment,
                                bundle
                            )
                        },
                        onViewLedgerClick = { id, name ->
                            val bundle = Bundle().apply {
                                putString("customerId", id)
                                putString("customerName", name)
                            }
                            findNavController().navigate(
                                R.id.action_customerProfileFragment_to_ledgerFragment,
                                bundle
                            )
                        }
                    )
